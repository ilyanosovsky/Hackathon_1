...
# Load images
RED_ENEMY = pygame.image.load("Space/assets/pixel_ship_red_small.png")
BLUE_ENEMY = pygame.image.load("Space/assets/pixel_ship_blue_small.png")
GREEN_ENEMY = pygame.image.load("Space/assets/pixel_ship_green_small.png")
YELLOW_PLAYER = pygame.image.load("Space/assets/pixel_ship_yellow.png")

RED_LASER = pygame.image.load("Space/assets/pixel_laser_red.png")
BLUE_LASER = pygame.image.load("Space/assets/pixel_laser_blue.png")
GREEN_LASER = pygame.image.load("Space/assets/pixel_laser_green.png")
YELLOW_LASER = pygame.image.load("Space/assets/pixel_laser_yellow.png")

# Scaling bg to fit window
BG = pygame.transform.scale(
    pygame.image.load("Space/assets/background-black.png"), (WIDTH, HEIGHT)
)
